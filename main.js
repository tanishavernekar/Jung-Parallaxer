...
var fggrass = new Image();
var telescope = new Image();
var jung = new Image();
...
var layer_list = [
  ...
  {
    image: ground,
    src: "./images/2-groundcritters-img.png",
    z_index: -2.8,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: spotlight,
    src: "./images/3-spotlight-img.png",
    z_index: -1.25,
    position: { x: 0, y: 0 },
    blend: "soft-light",
    opacity: 1,
  ...
  {
    image: fggrass,
    src: "./images/7-dense-foliage-img.png",
    z_index: -0.65,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: jung,
    src: "./images/6-jung-logo-img.png",
    z_index: 4.1,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
  ...
  {
    image: telescope,
    src: "./images/8-telescope-frame-img.png",
    z_index: 3.5,
    position: { x: 0, y: 0 },
    blend: null,
    opacity: 1,
